...
document.addEventListener("DOMContentLoaded", () => {
  $(($) => {
    ...
    // Profile Active
    $(".cmn__rightclick .clickhere-active, .global-scale").on(
      "click",
      function () {
        $(
          ".cmn__rightclick .cmn-rightclickbody, .kukis, .cmn-leftclickbody, .cmn-rightclickbody-profile, .overall-activeoverlay"
        ).toggleClass("active");
      }
    );
    ...
    $(document).ready(() => {
      const toggleSwitch = $(
        "#js-pricing-switch, #js-pricing-switch2, #js-pricing-switch3, #js-pricing-switch4, #js-pricing-switch5, #js-pricing-switch6, #js-pricing-switch7, #js-pricing-switch8, #js-pricing-switch9 input"
      );
